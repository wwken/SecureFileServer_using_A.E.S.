...
public class ClientAES {
    ...
    public static byte[] decrypt(byte[] password, byte[] k) throws javax.crypto.BadPaddingException {
        byte[] original = null;
        try {
            SecretKeySpec skeySpec = new SecretKeySpec(password, "AES");
            Cipher cipher = Cipher.getInstance("AES");
    ...
    public static byte[] decryptWithPadding(byte[] password, byte[] k) throws javax.crypto.BadPaddingException {
        byte[] original = null;
        try {
            SecretKeySpec skeySpec = new SecretKeySpec(password, "AES");
            Cipher cipher = Cipher.getInstance("AES");
